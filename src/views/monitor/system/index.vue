  ...
  <div class="min-h-500px flex-col-stretch gap-2">
      ...
      <NGrid :x-gap="8" item-responsive responsive="screen" cols="2 s:2 m:4 l:4 xl:4 2xl:4">
        ...
        <NGridItem>
          <NProgress
            type="dashboard"
            gap-position="bottom"
            color="rgb(var(--success-500-color))"
            :percentage="systemInfo?.jvm.memoryUsageRate"
          />
    ...
    <NCard :title="$t('page.monitor.system.operatingSystem.title')" size="small">
      <NDescriptions label-placement="left" bordered :column="2">
        ...
        <NDescriptionsItem :label="$t('page.monitor.system.operatingSystem.arch')">
          {{ systemInfo?.operatingSystem.arch }}
        </NDescriptionsItem>
        <NDescriptionsItem :label="$t('page.monitor.system.operatingSystem.systemBootTime')">
          {{ systemInfo?.operatingSystem.systemBootTime }}
        </NDescriptionsItem>
        <NDescriptionsItem
          :label="$t('page.monitor.system.operatingSystem.systemUptime')"
    ...
    <NGrid x-gap="8" y-gap="8" item-responsive responsive="screen" cols="1 s:1 m:2 l:2 xl:2 2xl:2">
      <NGridItem>
        <NCard :title="$t('page.monitor.system.globalMemory.title')" size="small">
          <NDescriptions label-placement="left" bordered :column="1">
            <NDescriptionsItem :label="$t('page.monitor.system.globalMemory.total')">
              {{ systemInfo?.globalMemory.total }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.globalMemory.used')">
              {{ systemInfo?.globalMemory.used }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.globalMemory.available')">
              {{ systemInfo?.globalMemory.available }}
            </NDescriptionsItem>
            <NDescriptionsItem
              :label="$t('page.monitor.system.globalMemory.memoryUsedRate')"
              label-style="color:red;"
              content-style="color:red;"
            >
              {{ $t('page.monitor.percentage', { value: systemInfo?.globalMemory.memoryUsedRate }) }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.globalMemory.swapTotal')">
              {{ systemInfo?.globalMemory.swapTotal }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.globalMemory.swapUsed')">
              {{ systemInfo?.globalMemory.swapUsed }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.globalMemory.swapFree')">
              {{ systemInfo?.globalMemory.swapFree }}
            </NDescriptionsItem>
            <NDescriptionsItem
              :label="$t('page.monitor.system.globalMemory.swapUsedRate')"
              label-style="color:red;"
              content-style="color:red;"
            >
      ...
      <NGridItem>
        <NCard :title="$t('page.monitor.system.jvm.title')" size="small">
          <NDescriptions label-placement="left" bordered :column="1">
            <NDescriptionsItem :label="$t('page.monitor.system.jvm.vmName')">
              {{ systemInfo?.jvm.vmName }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.jvm.vmVersion')">
              {{ systemInfo?.jvm.vmVersion }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.jvm.vmVendor')">
              {{ systemInfo?.jvm.vmVendor }}
            </NDescriptionsItem>
            <NDescriptionsItem
              :label="$t('page.monitor.system.jvm.uptime')"
              label-style="color:red;"
              content-style="color:red;"
            >
              {{ systemInfo?.jvm.uptime }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.jvm.heapMemoryMax')">
              {{ systemInfo?.jvm.heapMemoryMax }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.jvm.heapMemoryUsed')">
              {{ systemInfo?.jvm.heapMemoryUsed }}
            </NDescriptionsItem>
            <NDescriptionsItem :label="$t('page.monitor.system.jvm.nonHeapMemoryUsed')">
              {{ systemInfo?.jvm.nonHeapMemoryUsed }}
            </NDescriptionsItem>
            <NDescriptionsItem
              :label="$t('page.monitor.system.jvm.memoryUsageRate')"
              label-style="color:red;"
              content-style="color:red;"
            >
    ...
    <NGrid x-gap="8" y-gap="8" item-responsive responsive="screen" cols="1 s:1 m:2 l:2 xl:2 2xl:2">
      <NGridItem>
        <NCard title="CPU" size="small">
          <NDescriptions label-placement="left" bordered :column="1">
            <NDescriptionsItem :label="$t('page.monitor.system.centralProcessor.name')">
              {{ systemInfo?.centralProcessor.name }}
            </NDescriptionsItem>
            ...
            <NDescriptionsItem
              :label="$t('page.monitor.system.centralProcessor.idlePercent')"
              label-style="color:red;"
              content-style="color:red;"
            >
